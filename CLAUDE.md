...
- Held walking now pivots and continues at an L corner when forward is blocked, backward is open, and exactly one side is open. Blocked T junctions and dead ends wait. Ordinary tap behavior is unchanged; releasing during a pivot does not queue a subsequent walk.
